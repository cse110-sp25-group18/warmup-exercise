...
function testFlipButton() {
  ...
  assertEquals(
    card1._isFaceUp,
    true,
    "Top card should be face up after button click",
  );
  ...
  assertEquals(
    card1._isFaceUp,
    false,
    "Top card should be face down after second button click",
  );
...
function addVisualDemo() {
  ...
  statusDisplay.innerHTML =
    "<p><strong>Current status:</strong> Top card is face down</p>";
