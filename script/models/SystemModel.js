...
class SystemModel {
    ...
    determineWinner(playerCards, dealerCards) {
        ...
        // Check for busts
        if (this.checkBust(playerCards)) {
            this.gameResult = 'dealer';
            return this.gameResult;
        }
        
        if (this.checkBust(dealerCards)) {
            this.gameResult = 'player';
            return this.gameResult;
        }
        
        // Check for blackjacks
        const playerHasBlackjack = this.checkBlackjack(playerCards);
        const dealerHasBlackjack = this.checkBlackjack(dealerCards);
